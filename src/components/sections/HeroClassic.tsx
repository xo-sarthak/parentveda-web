...
/*
 * PRESERVED — the original hero composition (copy left / floating phone +
 * orbiting pills right). Not rendered anywhere; kept intact so we can revert.
 * The live hero is Hero.tsx (centered editorial masthead + journey band).
 */
